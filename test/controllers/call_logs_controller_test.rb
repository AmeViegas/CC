...
class CallLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call_log" do
    assert_difference('CallLog.count') do
      post call_logs_url, params: { call_log: { calldate: @call_log.calldate, caller: @call_log.caller, comments: @call_log.comments, customer_id: @call_log.customer_id } }
    end
  ...
  test "should update call_log" do
    patch call_log_url(@call_log), params: { call_log: { calldate: @call_log.calldate, caller: @call_log.caller, comments: @call_log.comments, customer_id: @call_log.customer_id } }
